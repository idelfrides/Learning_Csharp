...
5 -> PRACTICE SOLID PRINCIPLES IN C# : `DONE ( 2026-03-01 )`

6 -> PARALELISMO EN C# : `PENDING`

7 -> INTERATE WITH OPERATING SYSTEM FILES AND DIRECTORIES : `PENDING`

8 -> ACCESS DATABASES USING ADO.NET : `PENDING`

9 -> WORK WITH JSON DATA IN C# : `DONE`

10 -> BUILD A SIMPLE WEB API USING ASP.NET CORE : `PENDING`

11 -> WORKING WITH AWS SDK FOR .NET : `PENDING`
